...
Для того, чтобы получить практические навыки работы с динамической маршрутизацией и развёртыванием простого однозонного OSPF предлагается следующее: 
...
Готовый стенд необходимо приложить в "Чат с преподавателем" в соответствующей теме.
Схемы, скриншоты, выводы консоли и комментарии в README приветствуются.
...
Если в процессе выполнения возникнут вопросы, то вы можете задать их в slack вашей группы.
